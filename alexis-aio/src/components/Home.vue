      ...
      <ul class="grid gap-10 sm:grid-cols-2 lg:grid-cols-3 px-5">
        ...
        <li>
          <HomeCard
            ...
            cardText="Alexis AIO will never be outdated - by listening to its users and through their own initiative, Alexis AIO will always be kept up-to-date for users."
          >
          </HomeCard>
        </li>
      </ul>
